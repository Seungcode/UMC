...
export const status = {
    ...
    LOCATION_NOT_FOUND: {status: StatusCodes.NOT_FOUND, "isSuccess": false, "code": "ARTICLE4001", "message": "등록된 지역이 없습니다."},
    STORE_NOT_FOUND: {status: StatusCodes.NOT_FOUND, "isSuccess": false, "code": "ARTICLE4001", "message": "등록된 가게가 없습니다."},
    MEMBER_NOT_FOUND: {status: StatusCodes.NOT_FOUND, "isSuccess": false, "code": "ARTICLE4001", "message": "등록된 멤버가 없습니다."}
